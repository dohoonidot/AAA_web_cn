                  ...
                  {(employee.startDate || employee.endDate) && (
                    <>
                      ...
                      <Box>
                        ...
                        <Typography sx={{ fontSize: '13px', fontWeight: 500, color: isDarkTheme ? '#FFFFFF' : '#374151' }}>
                          {employee.startDate ? formatServerDateTime(employee.startDate).split(' ')[0] : '-'} ~ {employee.endDate ? formatServerDateTime(employee.endDate).split(' ')[0] : '-'}
                        </Typography>
                        {(() => {
                          const halfDaySlot = employee.halfDaySlot || (employee as any).half_day_slot;
                          ...
                          return (
                            <Typography sx={{ fontSize: '11px', color: isDarkTheme ? 'rgba(255, 255, 255, 0.5)' : '#9CA3AF', mt: 0.5 }}>
                              {halfDaySlot === 'AM' ? '오전' : halfDaySlot === 'PM' ? '오후' : halfDaySlot}
                            </Typography>
                          );
                        })()}
                      </Box>
                  ...
                  {employee.requestedDate && (
                    <>
                      ...
                      <Box>
                        ...
                        <Typography sx={{ fontSize: '13px', fontWeight: 500, color: isDarkTheme ? '#FFFFFF' : '#374151' }}>
                          {formatServerDateTime(employee.requestedDate)}
                        </Typography>
                      </Box>
                    </>
                  )}
    ...
    return (
      <TableContainer
        ...
        sx={{
          ...
          maxHeight: { xs: 'calc(var(--app-height) - 200px)', md: 'calc(100vh - 200px)' },
          overflow: 'auto',
        }}
      >
        <Table stickyHeader>
