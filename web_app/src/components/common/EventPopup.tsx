...
export default function EventPopup({ open, title, message, onClose, onGoGift }: EventPopupProps) {
    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          overflow: 'hidden',
          bgcolor: '#FFFFFF',
          boxShadow: '0 0 0 1px rgba(99,102,241,0.3), 0 25px 60px rgba(15, 23, 42, 0.5)',
          '@keyframes zoomIn': {
