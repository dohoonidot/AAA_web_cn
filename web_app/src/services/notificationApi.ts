 ...
 * @returns 알림 목록
 */
export const getAlerts = async (userId: string, forceRefresh = false): Promise<AlertItem[]> => {
  try {
    const requestBody: CheckAlertsRequest = { user_id: userId, force_refresh: forceRefresh };
